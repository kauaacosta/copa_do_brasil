...
export default class BottomTabNavigator extends Component {
  ...
  renderStory = props => {
   ...
   renderPerfil = props => {
    return <Perfil setUpdateToTrue={this.changeUpdated} {...props} />;
  }; 
  renderSair = props => {
    return <Logout setUpdateToTrue={this.changeUpdated} {...props} />;
  };
          ...
          tabBarIcon: ({ focused, color, size }) => {
            ...
            if (route.name === "Feed") {
              ...
              iconName = focused ? "add-circle" : "add-circle-outline";
               ...
               iconName = focused ? "exit": "add-exit-outline";
            } else{
